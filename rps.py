...
def play(player_choice):
    ...
    # The game logic
    #The game logic
    if (player_choice == choices[0] and computer_choice == choices[0]) or \
       (player_choice == choices[1] and computer_choice == choices[1]) or \
       (player_choice == choices[2] and computer_choice == choices[2]):
